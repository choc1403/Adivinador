...
INSERT INTO PreguntasPredeterminadas(idPregunta, pregunta, nodoPadre, nodoDerecho)
    VALUES(8,'ES UN ANFIBIO',6,10);

INSERT INTO PreguntasPredeterminadas(idPregunta, pregunta,nodoPadre,nodoDerecho)
    VALUES(3,'PUEDE HABLAR?',1,11);

INSERT INTO Aves(idPregunta, nombre)
    VALUES(3, 'LORO');

INSERT INTO PreguntasPredeterminadas(idPregunta, pregunta, nodoPadre,nodoDerecho)
    VALUES(5,'TIENE TENTACULOS?',2,12);

INSERT INTO Acuaticos(idPregunta, nombre)
    VALUES(5,'PULPO');

INSERT INTO PreguntasPredeterminadas(idPregunta, pregunta,nodoPadre,nodoDerecho)
    VALUES(7,'Su animal es el personaje principal de la serie animada de Bojack Horseman?',4,13);
